...
Access https://github.com/marc55s/blog/actions and click the green button to enable actions.

## Step 3

Access https://github.com/marc55s/blog/settings/pages and set the
...
Your blog will be published at https://marc55s.github.io/blog
...
```console
$ git clone git@github.com:marc55s/blog.git
$ cd blog
```
